...
- **GitHub Pages ミラー**: https://anomixer.github.io/js7800/
...
*   **グローバルリーダーボード多言語サポート**: グローバルリーダーボードページも同じ 11 言語をサポートし、メインエミュレーターの言語設定と自動的に同期します。
...
### 08/28/26 (0.1.0 - フォーク版)
    - 多言語サポート（11言語：日本語、英語、繁体字中国語、簡体字中国語、韓国語、ドイツ語、スペイン語、フランス語、イタリア語、ポルトガル語、ロシア語）
    - グローバルハイスコアリーダーボードのリアルタイム同期と Master SRAM 保護
    - Cloudflare Pages と GitHub Pages ミラーへの自動デュアルデプロイ
    - レトロ HighScore Cartridge ハードウェア互換の2段階 SRAM 書き込みサポート
    - 8並発高速同期と Smart Diff による完全無料キャッシュ最適化
    - イベント駆動型同期：公式アップストリームへの即時書き込み（0秒）とクラウド約18秒の自動合流ミラー
